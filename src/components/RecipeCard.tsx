...
const RecipeCard = ({ recipe }: RecipeCardProps) => {
  ...
  return (
    <>
      <div className="flex max-w-sm transform flex-col justify-around rounded-xl shadow-lg shadow-zinc-900 transition-transform duration-300 hover:scale-105">
        <Image
          src={
          ...
          className="h-44 w-full rounded-t-2xl object-cover md:h-36 xl:h-48"
        />
